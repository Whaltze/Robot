...
: ${AMENT_CURRENT_PREFIX:="/home/whaltze/rm/test/test1/install/cpp_1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_1/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp_1/environment/path.sh"
